...
//   // Get route parameters from URL and select appropriate data
//   const searchParams = useSearchParams();
//   const pathname = usePathname();
  
//   // Update data when pathname changes
//   useEffect(() => {
...
//   // Parse new URL format: /brands/Service_Name or /flavours/Service_Name etc.
...
//     // Fallback to old solution parameter for backward compatibility
...
//                       feature.results?.map((result: { title: string; description: string }, index: number) => (
