...
export default function Human() {
  ...
  const steps = [
    {
      ...
      duration: '10 min',
      description: 'We analyze turnover data and employee feedback to identify root causes (e.g., toxic culture drives 32% of quits).',
    },
    {
      number: '2',
      title: 'Employee-Centric Policies',
      duration: '7 days',
      description: 'We craft HR policies and communication that put employees first (competitive benefits, clear career paths).',
    },
    {
      number: '3',
      title: 'Technology Integration',
      duration: '14 days',
      description: 'We implement HR software to automate tasks (onboarding, time tracking) and improve efficiency.',
    },
  ];
  ...
  const testimonials = [
    {
      quote:
        "Update your HR policies (POSH, handbooks) to meet current laws.",
      role: "Policy & Compliance Audit",
      avatar: "https://randomuser.me/api/portraits/women/44.jpg",
    },
    {
      quote:
        "Set up an onboarding checklist and software to ensure new hires feel welcomed.",
      role: "Automated Onboarding",
      avatar: "https://randomuser.me/api/portraits/men/32.jpg",
    },
    {
      quote:
        "Launch quick employee surveys to gauge engagement and identify issues.",
      role: "Feedback Surveys",
         ...
         {/* Featured Video Section */}
          <div className="relative mt-12 md:mt-16 w-full max-w-5xl px-4">
            ...
            <div className="relative w-full rounded-3xl overflow-hidden shadow-[0_32px_80px_rgba(70,65,150,0.22)]" style={{ background: '#09094C' }}>
              ...
              <LazyHeroVideo src="/video/2/HR-HUMANS.mp4" />
...
Empower your workforce with strategic recruitment and HR management solutions. Hiring and keeping talent is one of the biggest challenges companies face. In fact, 93% of organizations say retention is a top concern. BlueBerrie helps you attract the right people and create a positive culture so your team thrives.                </p>
              </div>
            </div>
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="absolute inset-0 z-0">
          ...
          <p className="text-lg md:text-xl text-[#09094C]/80 mb-10 font-bold  max-w-2xl mx-auto leading-relaxed ">
             Optimize your HR today. Contact BlueBerrie for a free HR assessment, and let us help you build a workforce that supports your growth.
